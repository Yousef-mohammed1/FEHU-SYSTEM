...
public:
    ...
    void setupUi(QDialog *ChangePassword)
    {
        ...
        ChangePassword->resize(389, 305);
        label_title = new QLabel(ChangePassword);
        ...
        btn_save = new QPushButton(ChangePassword);
    ...
    void retranslateUi(QDialog *ChangePassword)
    {
        ...
        label_title->setText(QCoreApplication::translate("ChangePassword", "Change Password", nullptr));
        ...
        btn_save->setText(QCoreApplication::translate("ChangePassword", "Save", nullptr));
    } // retranslateUi

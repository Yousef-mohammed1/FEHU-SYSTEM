...
template <> constexpr inline auto edit::qt_create_metaobjectdata<qt_meta_tag_ZN4editE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<edit, qt_meta_tag_ZN4editE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject edit::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN4editE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN4editE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN4editE_t>.metaTypes,
    nullptr
} };
...
void *edit::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN4editE_t>.strings))
